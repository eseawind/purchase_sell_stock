 ...
 */
public class AutoCompleteAdater_buyname extends SimpleCursorAdapter {
	...
	public AutoCompleteAdater_buyname(Context context, int layout, Cursor c, String from, int to,int flags) {
	...
	public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
		if (constraint != null) {
			return getDbHelper().query_buyname((String) constraint);
		} else {
			return null;
		}
	}
