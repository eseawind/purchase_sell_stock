 ...
 */
public class AutoCompleteAdater_tuicang extends SimpleCursorAdapter {
	...
	public AutoCompleteAdater_tuicang(Context context, int layout, Cursor c, String from, int to,int flags) {
	...
	public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
		if (constraint != null) {
			return getDbHelper().query_tuicang((String) constraint);
		} else {
			return null;
		}
	}
